...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::resource('/abortion-counselling', 'AbortionCounsellingchecklistController');
    Route::get('/save/abortion-counselling', 'AbortionCounsellingchecklistController@store');

    Route::resource('/abortion-MVA', 'AbortionMVAChecklistController');
    Route::get('/save/abortion-MVA', 'AbortionMVAChecklistController@store');

    Route::resource('/abortion-MA', 'AbortionMAChecklistController');
    Route::get('/save/abortion-MA', 'AbortionMAChecklistController@store');

    Route::resource('/PAC', 'PACChecklistController');
    Route::get('/save/PAC', 'PACChecklistController@store');

    Route::resource('/abortion-PAC-facility', 'AbortionPACFacilityChecklistController');
    Route::get('/save/abortion-PAC-facility', 'AbortionPACFacilityChecklistController@store');
