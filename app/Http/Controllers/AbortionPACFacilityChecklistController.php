...
class AbortionPACFacilityChecklistController extends Controller
{
    public function index()
    {
        ...
        return view('admin.AbortionPACFacilityChecklist',compact(['codigo', 'abortionCounsellingchecklist']));
    }
