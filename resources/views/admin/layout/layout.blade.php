...
<head>
    ...
    <title>PSI Moz | Safe Abortion </title>
...
<boby>
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li class="active"><a href="">HNQIS Safe Abortion Checklists</a></li>
                            <!--<li><a href="{{route('about.index')}}">About</a></li> -->
                                <li class="dropdown hoves"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Menu<b class="caret"></b></a>
                                    ...
                                    <!--   <li><a href="{{route('report.index')}}">Reports</a></li> -->
                                        ...
                                        <li><a href="{{route('abortion-counselling.index')}}" class="">Abortion Counselling checklist</a></li>
                                        <li><a href="{{route('abortion-MVA.index')}}" class="">Abortion MVA Checklist</a></li>
                                        <li><a href="{{route('abortion-MA.index')}}" class="">Abortion MA Checklist</a></li>
                                        <li><a href="{{route('PAC.index')}}" class="">PAC Checklist</a></li>
                                        <li><a href="{{route('abortion-PAC-facility.index')}}" class="">Abortion PAC Facility Checklist</a></li>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row bort">
                ...
                <div class="copyright">
                    2018 © Copyright Safe Abortion Checklists | PSI Moz. <a href="http://evidencias.psi.org.mz/" target="_blank">Powered by: PSI Moz Evidence Team</a>
                </div>
    ...
    <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/buttons/1.5.1/js/buttons.jqueryui.min.js"></script>
